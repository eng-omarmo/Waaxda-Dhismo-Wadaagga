    ...
    <div class="table-responsive">
      <table class="table align-middle">
        ...
        <tbody>
          ...
          @empty
            <tr><td colspan="7" class="text-center text-muted">No approvals found.</td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
    ...
    <div class="table-responsive">
      <table class="table table-sm">
        ...
        <tbody>
          ...
          @empty
            <tr><td colspan="3" class="text-muted text-center">No changes recorded.</td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
...
function initSig() {
  ...
  canvas.addEventListener('touchstart', e => {
    ...
    const t = e.touches[0];
    drawing = true; last = [t.clientX - rect.left, t.clientY - rect.top];
  }, {passive: true});
  canvas.addEventListener('touchend', () => { drawing = false; last = null; }, {passive: true});
  canvas.addEventListener('touchmove', e => {
    ...
    ctx.stroke();
    last = [t.clientX - rect.left, t.clientY - rect.top];
  }, {passive: true});
}
